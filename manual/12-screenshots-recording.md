...
On an Apple keyboard, `Super + Ctrl + C` opens Capture. Screenrecord then asks which audio you want; after that, drag a region or click a window or monitor. The same menu shows Stop while a recording is running.
